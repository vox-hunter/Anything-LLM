      ...
      <div className="flex flex-col gap-y-1 mt-2">
        ...
        <p className="text-sm text-white/60">
          {chatMode === "chat" ? (
            ...
            <>
              <b>Study</b> mode transforms the workspace into an AI Socratic
              tutoring environment. The AI will guide learning step-by-step
              using <i className="font-semibold">only</i> the uploaded
              documents, with interactive exercises and questions.
            </>
          )}
        </p>
      </div>
